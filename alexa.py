    ...
    if(pas=="774789"):
        ...
        while True:
            ...
            #     os.startfile(npath)
                ...
                if qry=="abir" or qry=="soumi" or qry=="oni" or qry=="didi" or qry=="tubelight" or qry=="tushar" or qry=="shilpy" or qry=="durjoy":
                    pi.press('win')
                    time.sleep(2)
            ...
            elif "close this window" in query or "close the window" in query: #100
